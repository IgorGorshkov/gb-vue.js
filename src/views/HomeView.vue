<template>
  <div class="home">
    <div>
      ...
      <formVisiabilityButton :classBtn="'show'" :show="show" @changeVisiability="changeVisiability('show')">
        Add new cost
      </formVisiabilityButton>
      <div v-show="show">
        <formPaymentAdd />
      </div>
      <paymentsList :payments="currentPageElements" :currentPage="current" :elementsOnPage="elementsOnPage" />
      <paginationModule :current="current" :length="getPaymentsList.length" :elementsOnPage="elementsOnPage"
